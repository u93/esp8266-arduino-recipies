...
bool FIRST_FLAG; //It's recommended to use only flags when triggering a timer-inturrumption related functionality
Ticker Networking; //Instance of Ticker, can be made as necessary
